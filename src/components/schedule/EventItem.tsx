...
const EventItem = ({ schedule }: Props) => {
  return (
    <Link
      ...
      className={`mx-6 mb-4 flex cursor-pointer items-start rounded-lg border border-2 px-1 py-2 shadow-sm transition duration-300 ease-in-out hover:scale-[1.02] hover:shadow-md`}
    >
